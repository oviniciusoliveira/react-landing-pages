...
describe('<Heading />', () => {
  ...
  it('should render correct heading sizes', () => {
    ...
    expect(screen.getByRole('heading', { name: 'texto' })).toHaveStyle({ 'font-size': theme.font.sizes.xlarge });
    ...
    expect(screen.getByRole('heading', { name: 'texto' })).toHaveStyle({ 'font-size': theme.font.sizes.large });
    ...
    expect(screen.getByRole('heading', { name: 'texto' })).toHaveStyle({ 'font-size': theme.font.sizes.xhuge });
  });
